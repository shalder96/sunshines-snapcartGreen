      ...
      <div className="flex items-center justify-between px-4 py-3 mx-auto max-w-7xl">
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `transition hover:text-green-600 ${
                  isActive ? "text-green-600" : "text-green-100"
                }`
              }
            >
              {item.name}
        ...
        <div className="flex-row items-center hidden gap-6 md:flex">
          ...
          <GoSearch
            ...
            size={22}
            className="text-green-100 cursor-pointer hover:text-green-600"
          />
          {/* Account  */}
          <div className="relative group">
            ...
            <div className="absolute right-0 hidden pt-3 group-hover:block">
              <div className="flex flex-col w-40 gap-2 px-4 py-3 text-green-100 bg-green-900 rounded-lg shadow-lg">
                <button className="px-2 py-1 text-left rounded-md hover:text-green-600">
                  Profile
                </button>
                <button className="px-2 py-1 text-left rounded-md hover:text-green-600">
                  Orders
          ...
          <NavLink
            to="/cart"
            className={({ isActive }) =>
              `relative inline-flex items-center transition-colors duration-200 hover:text-green-600 ${
                isActive ? "text-green-600" : "text-green-100"
              }`
            }
          >
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            {/* Bottom Section (Search + Account + Cart) */}
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative inline-flex items-center transition-colors duration-200 hover:text-green-600 ${
                    isActive
                      ? "text-green-600"
                      : "dark:text-green-100 text-gray-600"
                  }`
                }
              >
